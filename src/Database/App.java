...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String url = "jdbc:mysql://localhost:3306/programpenjualan";
...
private static void tambahdata() throws SQLException{
    ...
    try{
        ...
        String sql = "INSERT INTO transaksi (namakasir, nofaktur, namabarang, jumlahbarang, hargabarang, totalbelanja) VALUES ('"+transaksi.Kasir+"','"+transaksi.noFaktur+"','"+transaksi.namaBarang+"','"+transaksi.jumlah+"','"+transaksi.hargaBarang+"', '"+transaksi.subTotal+"')";
...
private static void ubahdata() throws SQLException{
    ...
    try{
        ...
        if(result.next()){
            System.out.print("Nama Kasir ["+result.getString("namakasir")+"]\t: ");
            transaksi.Kasir = inputan.next();
            ...
            sql = "UPDATE transaksi SET namakasir='"+transaksi.Kasir+"', namabarang='"+transaksi.namaBarang+"', jumlahbarang='"+transaksi.jumlah+"' , hargabarang='"+transaksi.hargaBarang+"' WHERE nofaktur='"+transaksi.noFaktur+"' ";
...
private static void caridata () throws SQLException {
    ...
    while(result.next()){
        System.out.println("\nNama Kasir\t");
        System.out.println(result.getString("namakasir"));
        System.out.println("\nNomor Faktur\t");
